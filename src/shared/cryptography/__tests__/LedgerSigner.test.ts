...
describe('LedgerSigner', () => {
    ...
    beforeEach(() => {
        jest.spyOn(cryptography, 'toSerializedSignature').mockReturnValue(
            'mockSerializedSignature'
        );
    ...
    it('should get address', async () => {
        ...
        expect(mockSuiLedgerClient.getPublicKey).toHaveBeenCalledWith(
            'derivationPath'
        );
    ...
    it('should sign data', async () => {
        ...
        expect(mockSuiLedgerClient.signTransaction).toHaveBeenCalledWith(
            'derivationPath',
            data
        );
    ...
    it('should connect to a new client', () => {
        const newLedgerSigner = ledgerSigner.connect(
            mockSuiClient as unknown as SuiClient
        );
