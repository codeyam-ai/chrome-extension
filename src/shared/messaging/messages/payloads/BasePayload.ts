...
export type PayloadType =
    ...
    | 'execute-sign-personal-message-request'
    | 'execute-sign-personal-message-response'
    | 'sign-personal-message-request-response'
    | 'get-sign-personal-message-requests'
    | 'get-sign-personal-message-request-response'
