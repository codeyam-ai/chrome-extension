      ...
      <BottomMenuLayout>
        <Content>
          <div className={st.pageDescription}>
            Staking SUI provides SUI holders with rewards in addition to market
            price gains.
          </div>
          ...
          <div className={st.titleSectionContainer}>
            <span className={st.sectionTitle}>Currently Staking</span>
            <SuiButton size="small" mode="primary">
              <span>Claim All Rewards</span>
              <Icon icon={SuiIcons.ArrowRight} className={st.arrowIcon} />
            </SuiButton>
          </div>
          <div className={st.stakedContainer}>{DEMO_STAKED}</div>
        </Content>
        <Menu stuckClass={st.shadow}>
          <SuiButton size="large" mode="neutral" className={st.action}>
            <Icon icon={SuiIcons.Close} className={st.closeActionIcon} />
            Cancel
          </SuiButton>
          <SuiButton size="large" mode="primary" className={st.action}>
            Stake Coins
            <Icon icon={SuiIcons.ArrowRight} className={st.arrowActionIcon} />
          </SuiButton>
        </Menu>
      </BottomMenuLayout>
    </div>
