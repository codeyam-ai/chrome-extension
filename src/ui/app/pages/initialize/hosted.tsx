...
const HostedPage = () => {
  ...
  const _handleEmailChange = useCallback((e: ChangeEvent<HTMLInputElement>) => {
          ...
          <div className="text-center space-y-2 py-4 text-base leading-7">
            ...
            {emailSent ? (
              ...
              <div className="text-sm text-gray-700 dark:text-gray-400">
                <p>
                  There&apos;s been an error and the team has been notified.
                </p>
                <br />
                <p>
              ...
              <form className="flex flex-col gap-1" onSubmit={_handleSubmit}>
                ...
                <div className="flex justify-center">
                  {loading ? (
                    ...
                    <Button buttonStyle={ButtonStyle.PRIMARY} type="submit">
                      Sign in
                    </Button>
                  )}
                </div>
