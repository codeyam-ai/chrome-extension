                            ...
                            ? [
                                {
                                    ...
                                    detail: reading.map(
                                        (r) =>
                                            `${formatAddress(r?.address)}::${r?.module
                                            }::${r?.name}`
                                    ),
                                },
                                {
                                    ...
                                    detail: mutating.map(
                                        (m) =>
                                            `${formatAddress(m?.address)}::${m?.module
                                            }::${m?.name}`
                                    ),
                                },
                                {
                                    ...
                                    detail: transferring.map(
                                        (t) =>
                                            `${formatAddress(t?.address)}::${t?.module
                                            }::${t?.name}`
                                    ),
                                },
                                {
                            ...
                            ? [
                                {
                                    ...
                                    detail: creating.map(
                                        (c) =>
                                            `${formatAddress(c?.address)}::${c?.module
                                            }::${c?.name}`
                                    ),
                                },
                                {
