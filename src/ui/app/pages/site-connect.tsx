      ...
      {permissionRequest ? (
        ...
        >
          <div className="pb-6 flex gap-3 justify-center items-center">
            <img src={permissionRequest.favIcon} alt="Site Favicon" />
            <div className="text-sm">
              <div className="">Connect your wallet to:</div>
              <div>{permissionRequest.title || permissionRequest.origin}</div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 mt-2">
            {permissionRequest.permissions.map((aPermission) => (
              <span className="flex flex-row gap-1" key={aPermission}>
                {greenCheckIcon}
