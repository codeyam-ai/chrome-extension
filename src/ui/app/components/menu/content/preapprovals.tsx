  ...
  const Preapproval = ({
    ...
    return (
      <div className="mb-6 rounded-md bg-gray-100 p-3">
        <div className="flex gap-3 items-center justify-between">
          ...
          <div className="truncate">
            <div className="text-base">
              {preapprovalRequest.originTitle || preapprovalRequest.origin}
            </div>
            <div className="">
        ...
        <div className="text-xs pt-2 cursor-pointer" onClick={_toggleDetails}>
    ...
    return (
      <div key={`wallet-connections-${name}`} className="mb-12">
        ...
        <ul className="grid grid-cols-1 gap-2">
          {preapprovals.map(
            (preapprovalRequest: PreapprovalRequest, index: number) => (
              <Preapproval
                key={`revoke-${index}`}
                preapprovalRequest={preapprovalRequest}
                onRevoke={onRevoke}
