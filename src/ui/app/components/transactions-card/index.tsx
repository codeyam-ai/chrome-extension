      ...
      <div className={st.card} key={txn.txId}>
        ...
        <div className={st.cardContent}>
          <div className={st.txResult}>
            ...
            {date && <div className="text-xs dark:text-gray-400">{date}</div>}
          </div>
          <div className={st.txResult}>
            <div className={st.txTypeName}>
              {txn.kind !== "Call" && txn.isSender ? "To" : "From"}
            </div>
        ...
        <div className={st.txTransferred}>
          {txn.amount && (
            <>
              <div className="text-right dark:text-white">{txn.amount} SUI</div>
          ...
          {txn.url && (
            <div className={st.txImage}>
              <img
                src={txn.url.replace(/^ipfs:\/\//, "https://ipfs.io/ipfs/")}
                alt="NFT"
              />
            </div>
          )}
