...
describe('iframe helper', () => {
  ...
  it('should listen for ready', () => {
    ...
    window.dispatchEvent(mockMessageEvent);
    expect(mockIframeElement.setAttribute).toHaveBeenCalledWith('readyToReceiveMessages', 'true');
    expect(removeEventListenerSpy).toHaveBeenCalledWith('message', expect.any(Function));
  });
  ...
  it('should listen for user', () => {
    ...
    window.dispatchEvent(mockMessageEvent);
    expect(mockIframeElement.setAttribute).toHaveBeenCalledWith('userReady', 'true');
    expect(removeEventListenerSpy).toHaveBeenCalledWith('message', expect.any(Function));
  });
