...
const BaseLayout = ({ className, children }: BaseLayoutProps) => {
    const defaultClasses =
        'mx-auto w-[360px] min-h-[475px] pt-4 shadow-ethos-box-shadow sm:rounded-lg text-center bg-ethos-light-background-default dark:bg-ethos-dark-background-default';
    return (
