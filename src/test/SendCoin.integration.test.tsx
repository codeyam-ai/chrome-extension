...
describe('send coin flow', () => {
    ...
    beforeEach(async () => {
        ...
        rpcMocks.sui_dryRunTransactionBlock('AAACAAgAypo7AAAAAAAg7JbTIOl80QFG+VOnnPncBaizXEaz6EKPeF7Drhtvj6YCAgABAQAAAQECAAABAQD/JjqUG5ZQtRIHpnTVlyj280EC02b031pZUUvDZoYC3gD/JjqUG5ZQtRIHpnTVlyj280EC02b031pZUUvDZoYC3gEAAAAAAAAAAMqaOwAAAAAA');
        rpcMocks.suix_getReferenceGasPrice();
        rpcMocks.suix_getCoins();
        rpcMocks.sui_dryRunTransactionBlock('');
