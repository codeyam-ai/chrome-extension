...
export const dryRunTransactionResponse: DryRunTransactionBlockResponse = {
    effects: {
        messageVersion: 'v1',
        status: {
            status: 'success',
        ...
        transactionDigest: '9TpW8wFiTEdNgv5H53FF3rmtkjY8sRhc2y3aKntvKiKp',
        created: [
            {
                owner: {
                    AddressOwner:
    ...
    events: [
        {
            id: {
                txDigest: '9TpW8wFiTEdNgv5H53FF3rmtkjY8sRhc2y3aKntvKiKp',
                eventSeq: '0',
            },
            packageId:
