...
describe('Importing a wallet using a seed phrase', () => {
    ...
    async function confirmAddress() {
        ...
        const walletAddressFromSeed = '0xff263a941b9650b51207a674d59728f6f34102d366f4df5a59514bc3668602de'
        await screen.findByText(walletAddressFromSeed.slice(0, walletAddressFromSeed.length / 2));
        await screen.findByText(walletAddressFromSeed.slice(walletAddressFromSeed.length / -2));
